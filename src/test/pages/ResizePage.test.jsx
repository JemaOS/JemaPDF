...
describe("ResizePage", () => {
  ...
  describe("English", () => {
    ...
    it("shows resize button after file selection", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByRole("button", { name: "Resize PDF" })).toBeInTheDocument();
      });
    });
    ...
    it("triggers resize when clicking resize button", async () => {
      ...
      await waitFor(() => {
        ...
        fireEvent.click(screen.getByRole("button", { name: /^Resize PDF$/ }));
  ...
  describe("French", () => {
    ...
    it("shows success message in French", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText("Redimensionnement terminée !")).toBeInTheDocument();
      });
    });
  });
});
