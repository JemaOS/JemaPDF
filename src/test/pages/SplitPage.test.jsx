...
describe("SplitPage", () => {
  ...
  describe("English", () => {
    ...
    it("shows split button after file selection", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText("Split into Pages")).toBeInTheDocument();
      });
    });
  ...
  describe("French", () => {
    ...
    it("shows split button in French", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText("Diviser en pages")).toBeInTheDocument();
      });
    });
    ...
    it("shows success message in French", async () => {
      ...
      await waitFor(() => {
        ...
        fireEvent.click(screen.getByText("Diviser en pages"));
